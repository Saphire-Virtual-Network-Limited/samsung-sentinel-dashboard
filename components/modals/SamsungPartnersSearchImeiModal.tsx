...
interface SamsungPartnersSearchImeiModalProps {
	buttonText?: string;
	buttonColor?:
		| "default"
		| "primary"
...
export default function SamsungPartnersSearchImeiModal({
	...
	showIcon = true,
	className = "",
}: SamsungPartnersSearchImeiModalProps) {
																			...
																			>
																				...
																				<td className="px-4 py-3 text-sm">
																					<Button
																						...
																						onPress={() => {
																							router.push(
																								`/access/samsung-partners/claims/${claim.id}`
																							);
																							handleClose();
																						}}
																					>
