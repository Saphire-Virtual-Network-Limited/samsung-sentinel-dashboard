...
const InceptionDashCard = () => {
	...
	const getChannelData = (channelData: any) => {
		return {
			...
			Average_Inception_Loan_Value:
				channelData.Average_Inception_Loan_Value || "0",
			Total_Enrolled_Devices_Since_Inception:
				channelData.Total_Enrolled_Devices_Since_Inception || 0,
		};
	};
		...
		return (
			...
			>
				...
				<CardBody className="p-4 space-y-1">
					...
					{renderMetricRow(
						"Total Value",
						data.Total_Inception_Loan_Value,
						true
					)}
					{renderMetricRow(
						"Average Value",
						data.Average_Inception_Loan_Value,
						true
					)}
					{renderMetricRow(
						"Enrolled Devices",
						data.Total_Enrolled_Devices_Since_Inception
					)}
				</CardBody>
	...
	const renderChannelChart = () => {
		...
		const chartData = [
			...
			{
				name: "Samsung",
				value: samsungData.Total_Inception_Loan,
				color: "#8b5cf6",
			},
			{
				name: "Xiaomi",
				value: xiaomiData.Total_Inception_Loan,
				color: "#f97316",
			},
			...
			{
				name: "9Mobile",
				value: nineMobileData.Total_Inception_Loan,
				color: "#ec4899",
			},
		];
