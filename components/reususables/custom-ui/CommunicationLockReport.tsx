...
import { Mail, MessageSquare, Phone, Lock, CheckCircle, XCircle } from "lucide-react";
        ...
        <CardBody className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              >
                {key === "phoneCalls" ? "Made" : key === "lock" ? "Locked" : "Sent"}
              </span>
            </div>
            <span
              className={cn(
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              >
                {key === "phoneCalls" ? "Not Made" : key === "lock" ? "Not Locked" : "Not Sent"}
              </span>
            </div>
            <span
              className={cn(
          ...
          <div className="pt-2 border-t border-gray-100">
            <div className="flex justify-between items-center">
              ...
              >
                {Math.round(((data.sent || data.made || data.locked) / data.total) * 100)}%
              </span>
            </div>
            {/* Progress bar */}
            <div className="w-full bg-gray-200 rounded-full h-1.5 mt-1">
              <div
                ...
                style={{
                  width: `${((data.sent || data.made || data.locked) / data.total) * 100}%`,
                }}
              ></div>
            </div>
          </div>
