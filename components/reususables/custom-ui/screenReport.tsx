...
import { TrendingDown, TrendingUp, BarChart3, AlertTriangle, CheckCircle, Clock, UserCheck, CreditCard, FileText, Shield, DollarSign, Smartphone } from "lucide-react";
...
const ScreenReport = () => {
    ...
    const screens = ["BVN Credit Check", "Loan Eligibility Check", "Card Tokenization","Loan Data Submission", "KYC Submission", "Mandate Creation", "Mandate Approved", "Down Payment", "Virtual Account Creation", "Device Enrollment Started", "Device Enrollment Completed"];
    ...
    const screenDataArray = [
      ...
      { name: "Device Enrollment Completed", data: deviceEnrollmentCompletedData }
    ];
          ...
          <div className={cn("bg-gradient-to-r p-4", config.color)}>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <h2 className={cn("text-white font-semibold text-sm sm:text-base", GeneralSans_SemiBold.className)}>
                  {screen.name}
                </h2>
              </div>
      ...
      <div className="space-y-6">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Track user drop-offs across different stages of the loan application process
          </p>
        </div>
        ...
        {hasNoRecords && !isLoading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              There are no screen drop-off records available for the selected date range.
            </p>
          </div>
        )}
      </div>
