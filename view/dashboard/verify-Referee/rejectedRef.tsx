...
export default function RejectedRefereesPage() {
	...
	const [selectedItem, setSelectedItem] = useState<RejectedRefereeRecord | null>(null);
	...
	const { data: raw = [], isLoading } = useSWR(
		startDate && endDate ? ["rejected-refreees", startDate, endDate] : "rejected-refreees",
	...
	const handleApproveReferee = async (selectedItem: RejectedRefereeRecord | null, type: "referee1" | "referee2" | null) => {
	...
	const handleRejectReferee = async (selectedItem: RejectedRefereeRecord | null, type: "referee1" | "referee2" | null) => {
		if (!selectedItem || !type) return;
