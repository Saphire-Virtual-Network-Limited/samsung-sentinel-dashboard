...
export default function RejectedRefereesPage() {
	...
	const [selectedItem, setSelectedItem] =
		useState<RejectedRefereeRecord | null>(null);
	...
	const { data: raw = [], isLoading } = useSWR(
		startDate && endDate
			? ["rejected-refreees", startDate, endDate]
			: "rejected-refreees",
		() =>
			getRejectedReferees(startDate, endDate)
				.then((r) => {
				...
				.catch((error) => {
					console.error("Error fetching rejected referees:", error);
					setHasNoRecords(true);
					return [];
				}),
		{
	...
	const sorted = React.useMemo(() => {
		return [...paged].sort((a, b) => {
			const aVal = a[sortDescriptor.column as keyof RejectedRefereeRecord];
			const bVal = b[sortDescriptor.column as keyof RejectedRefereeRecord];
	...
	const handleApproveReferee = async (
		selectedItem: RejectedRefereeRecord | null,
	...
	const renderCell = (row: RejectedRefereeRecord, key: string) => {
		if (key === "actions") {
			return (
										...
										<div className="bg-default-50 p-4 rounded-lg">
											...
											<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
												...
												<div>
													...
													<p className="font-medium">
														{selectedItem.dobMisMatch ? "Yes" : "No"}
													</p>
												</div>
												<div>
