...
export default function AllCustomerRefereesPage() {
	...
	const [selectedItem, setSelectedItem] =
		useState<UnapprovedRefereeRecord | null>(null);
	...
	const { data: raw = [], isLoading } = useSWR(
		startDate && endDate
			? ["all-referees", startDate, endDate]
			: "all-referees",
		() =>
			getAllReferees(startDate, endDate)
				.then((r) => {
	...
	const handleApproveReferee = async (
		selectedItem: UnapprovedRefereeRecord | null,
	...
	const openModal = (mode: "view", row: UnapprovedRefereeRecord) => {
		...
		router.push(
			`/access/${role}/referees/unapproved-referees/${row.customerId}`
		);
	};
