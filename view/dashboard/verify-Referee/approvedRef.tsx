...
import { getApprovedReferees, capitalize, calculateAge, showToast, verifyCustomerReferenceNumber } from "@/lib";
...
export default function ApprovedRefereesPage() {
	...
	const [selectedItem, setSelectedItem] = useState<ApprovedRefereeRecord | null>(null);
	...
	const handleApproveReferee = async (selectedItem: ApprovedRefereeRecord | null, type: "referee1" | "referee2" | null) => {
	...
	const handleRejectReferee = async (selectedItem: ApprovedRefereeRecord | null, type: "referee1" | "referee2" | null) => {
		if (!selectedItem || !type) return;
