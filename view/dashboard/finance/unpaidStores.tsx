...
export default function UnpaidStoresView() {
	...
	const { data: raw = [], isLoading } = useSWR(
		startDate && endDate
			? ["unpaid-stores", startDate, endDate]
			: "unpaid-stores",
		() =>
		...
		if (key === "Status") {
			return (
				<Chip
					...
					color={
						statusColorMap[
							row.Status?.toLowerCase() as keyof typeof statusColorMap
						] || "default"
					}
					size="sm"
					variant="flat"
										...
										<div className="bg-default-50 p-4 rounded-lg">
											...
											<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
												...
												<div>
													...
													<p className="font-medium">
														{selectedItem.storeOnLoanId || "N/A"}
													</p>
												</div>
												<div>
												...
												<div>
													<div className="flex items-center justify-between col-span-2 mt-4">
														<div>
															<p className="text-sm text-default-500 my-2">
																Manual Payment
															</p>
															<SelectField
						...
						<>
							...
							<ModalBody>
								<p className="text-md text-default-500">
									Are you sure you want to mark this store as paid? This action
									cannot be undone.
								</p>
							...
							<ModalFooter className="flex gap-2">
								<Button
									...
									variant="solid"
									onPress={() =>
										selectedItem && handleUpdateStoreStatus(selectedItem)
									}
									isLoading={isButtonLoading}
								>
									Confirm Payment
