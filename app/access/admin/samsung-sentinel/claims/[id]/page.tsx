	...
	return (
		<div className="container mx-auto px-4 py-6">
			...
			<UnifiedClaimRepairDetailView
				claimData={claim}
				role="samsung-sentinel"
				onApprove={undefined} // Admin cannot approve
				onReject={undefined} // Admin cannot reject
				onAuthorizePayment={undefined} // Admin cannot authorize
				onExecutePayment={executePaymentHandler} // Admin can execute payment
